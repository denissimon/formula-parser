...
class FormulaParserTest extends TestCase
{
    ...
    public static function nanData() {
        return [
            ['sqrt(log(0)) + 1'],
            ['sqrt(-1.0)'],
            ['sqrt(-INF)'],
    ...
    public static function infData() {
        return [
            ['sqrt(5^500)', INF],
            ['10 + log(0)', -INF],
            ['-(5)^500+5', -INF],
    ...
    public static function variablesData() {
        return [
    ...
    public static function validVariablesData() {
    ...
    public static function operatorsData() {
        return [
            ['10/++--2', 5],
            ['-+8', -8],
            ['5^--2', 25],
    ...
    public static function expData() {
        return [
            ['10*(3-5)^4/2', 80],
            ['3+4*2/(1-5)^8', 3.0001],
            ['5^-500', 0],
    ...
    public static function otherCasesData() {
        return [
            ['5', 5],
            ['(10+5)', 15],
            ['-(-8)', 8],
